          ...
          <div className="flex items-center">
            ...
            >
              <div
                ...
                className={`${
                  isMobileMenuOpen ? 'block' : 'hidden'
                } fixed inset-0 w-full bg-blue-800 overflow-visible z-50 justify-between`}
              ></div>
              <div
                className={`${
                  isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'
                } md:translate-x-0 absolute overflow-visible -top-3 pl-2 justify-between -left-12 h-full pt-2 text-white w-full md:w-auto z-50 transform transition-transform duration-300 ease-in-out md:static  bg-blue-800 md:flex md:space-x-10`}
              >
                <Link
                  to="/"
